...
position = st.text_input("📌 المسمى الوظيفي (اختياري):", max_chars=30)
...
if name:
    ...
    shadow_offset = 2
    draw.text((x_name + shadow_offset, y_name + shadow_offset), bidi_name, font=font, fill="black")
    draw.text((x_name, y_name), bidi_name, font=font, fill="white")
